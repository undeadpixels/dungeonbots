...
public class JEntityEditor extends JPanel {
	...
	/*
	private static class UserScriptRenderer extends JLabel implements ListCellRenderer<UserScript>{

		@Override
		public Component getListCellRendererComponent(JList<? extends UserScript> list, UserScript item, int index,
	...
	public JEntityEditor(Entity entity) {
		...
		scriptScroller.setPreferredSize(new Dimension(250, this.getSize().height - 100));
		...
		tabPane.addTab("Scripts", null, scriptPanel, "Scripts relating to the player.");
